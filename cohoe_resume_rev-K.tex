...
Java Programming, Cyber Self-Defense, Computer System \& Network Fundamentals, Large Scale Computing with Mainframes, Perl Scripting, Web Design, System Administration, Data Modeling, Advanced Routing \& Switching, Wireless Networks, Network Services.
...
\textbf{Technology \& Infrastructure}: Ethernet, AOE, Routing \& Switching (TCP/IP), STP, Cooling Implementation, Power Distribution, Kerberos, NIS, Active Directory, DNS, DHCP, LDAP, Advanced Virtualization concepts \& implementation, SAN \& Cloud concepts
