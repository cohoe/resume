...
\textbf{Networking \& Services}: Ethernet, TCP/IP Routing \& Switching (IPv4 \& IPv6), [MR]STP, VTP, Link Aggregation, Frame Relay, Kerberos, NIS, Active Directory, DNS, DHCP, LDAP.
