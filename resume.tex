...
\textbf{Cloud Providers}: Amazon Web Services, Microsoft Azure, VMware vCloud

\textbf{Network}: Cisco Catalyst \& Nexus Switches, Brocade SAN Switching, Cisco IronPort WSA

\textbf{Services \& Applications}: OpenLDAP, BIND, Github Enterprise, Docker

\textbf{System Platforms}: Linux (RHEL, SLES, Debian, Gentoo), Windows Server (2003-2012R2), Solaris
...
\begin{outerlist}
    ...
    \item[] \textit{Senior System Administrator} (Engineering Lab Services / Release Engineering)
		...
		\item Take ownership of certain essential services such as package management and user authentication.
            \end{innerlist}
...
\href{http://www.emc.com/}{\textbf{RSA The Security Division of EMC}},
Bedford, MA
\begin{outerlist}

    \item[] \textit{Excellence@EMC Silver} (Transparent Proxy Implementation)
            \hfill \textbf{Q3 2014}
            \begin{innerlist}
		\item Collaborated across functional groups to implement a transparent proxy system in a lab environment.
		\item Defined and justified requirements and design to security architects and risk managers.		
            \end{innerlist}
\end{outerlist}
\halfblankline
...
\begin{outerlist}
 \item[]
            \begin{innerlist}
	                \item College Hockey Enthusiast
			\item Amateur Hockey Player
           	     \item \href{http://www.usfirst.org/roboticsprograms/frc}{FIRST Robotics Competition Volunteer}
		\item \href{http://ists.sparsa.org}{RIT Information Security Talent Search} participant (2nd place 2013, 3rd place 2011)
		\item Frequent TED(x) \& Barcamp Attendee
