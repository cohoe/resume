...
\begin{outerlist}
	...
	\begin{innerlist}
		...
		\item Develop new capabilities for the internal Kubernetes Developer Platform.
		\item Leverage LLM (``AI'') tools to deliver on a wide array of infrastructure projects.
        \end{innerlist}
\end{outerlist}
\halfblankline
