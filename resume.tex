...
\textbf{Platforms \& Providers}: Microsoft Azure, Amazon Web Services, Kubernetes/OpenShift, OpenStack

\textbf{Services \& Applications}: Docker, Prometheus, Grafana, ElasticSearch, Consul, RabbitMQ, Jenkins, Vault

\textbf{Databases}: MySQL/MariaDB, Percona, PostgreSQL, Cassandra, DynamoDB, Redis, SQLite

\textbf{Network}: Cisco, Juniper, F5, Ubiquiti, VPN (OpenVPN, IPsec, Wireguard), Tr{\ae}fik

\textbf{Operating Systems}: Linux (Focus on RHEL/CentOS/Fedora), FreeBSD, Windows, MacOS

\textbf{Software Development}: Python, Swift, Bash, Git
%% END SKILLS %%
...
\begin{outerlist}
	...
	\begin{innerlist}
		...
		\item Orchestrate Kubernetes-oriented deployments in Microsoft Azure using community and in-house tools.
		\item Provide support and guidance to internal teams and contractors to enable successful project delivery.
        \end{innerlist}
\end{outerlist}
\halfblankline
...
\textbf{Charter Cruise Twitter Clone} - \href{https://github.com/jocosocial/swiftarr}{https://github.com/jocosocial/swiftarr}
\begin{outerlist}
    \item[]
            \begin{innerlist}
	\item Contribute to a Twitter clone custom built for the unique culture of a nerd cruise.
...
\begin{innerlist}
	...
	\item Spend time in Adirondacks, Vermont, and Lake Erie regions.
