...
%% BEGIN SUMMARY %%
\section{Summary}
Operations engineer with excellent problem solving abilities and extensive knowledge in diverse technologies capable of making practice and policy recommendations and enabling others to do their best work.
%% END SUMMARY
...
\textbf{Platforms \& Providers}: Microsoft Azure, Amazon Web Services, Kubernetes (EKS, AKS, okd)
...
\textbf{Operating Systems}: Linux (Focus on RHEL/CentOS/Fedora \& Ubuntu/Debian), Windows, MacOS

\textbf{Languages}: Python, Swift, NodeJS, Bash, Go
...
\begin{outerlist}
	\item[] \textit{Senior Site Reliability Engineer} (Infrastructure Lifecycle \& Paved Path)
        \hfill \textbf{Feb 2024 to Aug 2025}
	\begin{innerlist}
		\item Maintain config management (Puppet, Terraform) and provisioning systems (cloud-init, Spacelift).
		\item Develop new capabilities for the internal Kubernetes Developer Platform such as multi-architecture.
		\item Leverage LLM (``AI'') tools to deliver on a wide array of cross-functional projects.
        \end{innerlist}
\end{outerlist}
\halfblankline
...
\begin{outerlist}
	...
	\begin{innerlist}
		...
		\item Build and test the on-premises Kubernetes platform integrating with many existing systems.
        \end{innerlist}
...
\begin{outerlist}
	...
	\begin{innerlist}
        ...
        \item Manage budgeting, auditing, and cost control for program operations.
		\item Point of contact for parents and advisor/mentor to main camp staff.
	\end{innerlist}
\end{outerlist}
%% END EXPERIENCE %%
...
\begin{innerlist}
	...
	\item Regular attendee of DevOpsDays Boston and other local \& national conferences.
