...
\section{Skills}
\textbf{Management Tools}: Puppet, VMware vSphere, Cisco UCS Manager, EMC Unisphere

\textbf{Cloud Providers}: Amazon Web Services, Microsoft Azure, VMware vCloud \& vCloud Air

\textbf{Network}: Cisco Catalyst \& Nexus Switching, IronPort WSA, VPN (IPsec, AnyConnect)

\textbf{Services \& Applications}: OpenLDAP, ISC-BIND/DHCPD, Jenkins, Github Enterprise, Docker

\textbf{System Platforms}: Linux (Focus: RHEL/SLES), Windows Server (2003-2012R2), Solaris

\textbf{Development}: Python, Bash, PHP, Git, Perforce
...
\begin{outerlist}
    ...
    \item[] \textit{Senior System Administrator} (Engineering Lab Services / Release Engineering)
            \hfill \textbf{July 2014 to Present}
            \begin{innerlist}
    ...
    \item[] \textit{System Administrator} (Engineering Lab Services / Release Engineering)
            \hfill \textbf{July 2013 to July 2014}
            \begin{innerlist}
		...
		\item Work with scrum development teams to ensure build environments are functional and secure.
            \end{innerlist}
\end{outerlist}
\halfblankline
